          ...
          <div className="p-10 md:p-14 flex flex-col justify-between">
            ...
            <div className="mt-10 space-y-4">
              <div className="flex items-center gap-3">
                ...
                <a href="mailto:contact@wftech.com" className="text-white/50 text-xs hover:text-white transition-colors">
                  contact@wftech.com
                </a>
              </div>
              <div className="flex items-center gap-3">
                ...
                <p className="text-white/50 text-xs">Cameroun, Yaoundé — News Street Nkolndogo</p>
              </div>
          ...
          <div className="bg-surface p-10 md:p-14 flex flex-col justify-center">
            {status === 'success' ? (
              <div className="text-center py-8">
                ...
                <h3 className="text-foreground text-lg font-bold mb-2">Message envoyé !</h3>
                <p className="text-muted text-sm mb-6 leading-relaxed">
                  Merci ! Notre équipe vous répondra dans les 24 heures ouvrées.
                </p>
                <button
              ...
              <form onSubmit={handleSubmit} noValidate className="space-y-4">
                <p className="label-tag text-muted mb-2">Envoyer un message</p>
