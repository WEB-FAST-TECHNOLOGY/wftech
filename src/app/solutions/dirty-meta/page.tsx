...
export const metadata: Metadata = {
  ...
  description: 'Dirty Meta est l\'outil d\'analyse et de nettoyage de métadonnées de WFTECH. Extraction, transformation et valorisation des données non structurées.',
