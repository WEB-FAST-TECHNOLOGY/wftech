...
export default function LogistikAgricolClient() {
  const { t } = useLanguage();
  const pageT = t.logistikagricol_page;
      ...
      <main className="pt-32 pb-24 min-h-screen bg-bg">
        <div className="max-w-5xl mx-auto px-6 md:px-8">
          ...
          <div className="mb-20">
            ...
            <div className="mb-6 relative w-[120px] h-[60px]">
              <div className="absolute inset-0 bg-gradient-to-tr from-primary/30 to-gradient-end/30 blur-2xl rounded-full" />
              <Image
                src="/assets/images/Screenshot_20260513_040035_Chrome-1778641301341.jpg"
                alt="Logo LogistikAgricol"
                width={120}
                height={60}
                className="object-contain relative z-10 drop-shadow-xl rounded"
              />
            </div>
          ...
          <div className="bg-gradient-to-br from-primary/5 to-gradient-end/5 border border-primary/20 rounded-3xl p-12 flex flex-col md:flex-row items-center justify-between gap-8 relative overflow-hidden text-center md:text-left">
            <div className="relative z-10">
              ...
              <p className="font-sans text-sm text-muted">Prêt à transformer votre logistique agricole ?</p>
            </div>
