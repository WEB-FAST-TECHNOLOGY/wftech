...
export default function AiMimicryClient() {
  const { t, language } = useLanguage();
  const pageT = t.aimimicry_page;
            ...
            '@graph': [
              {
                ...
                name: pageT.title + ' — ' + pageT.subtitle,
                description: pageT.intro,
                isPartOf: {
              ...
              },
              {
                ...
                offers: {
                  '@type': 'Offer',
                  priceCurrency: 'USD',
                  price: language === 'fr' ? 'Contactez-nous' : 'Contact us',
                },
              },
            ],
          }),
        ...
        <div className="max-w-5xl mx-auto px-6 md:px-8">
          ...
          <div className="bg-gradient-to-br from-primary/5 to-gradient-end/5 border border-primary/20 rounded-3xl p-12 flex flex-col md:flex-row items-center justify-between gap-8 relative overflow-hidden text-center md:text-left">
            <div className="relative z-10">
              ...
              <p className="font-sans text-sm text-muted">Prêt à déployer votre IA sur mesure ?</p>
            </div>
