...
const solutions: Solution[] = [
  ...
  },
  {
    ...
    description:
      'Solution de gestion immobilière et domotique. Pilotage des biens, suivi des locataires et automatisation des espaces de vie.',
  ...
  },
  {
    ...
    description:
      'Outil d\'extraction, de nettoyage et de valorisation des métadonnées. Transformez vos données brutes non structurées en insights exploitables grâce à des pipelines ETL visuels et une gouvernance maîtrisée.',
    ...
    <section id="solutions" className="max-w-7xl mx-auto w-full px-4 md:px-6 py-20 md:py-24">
      ...
      <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-6 mb-14">
        <div className="space-y-4">
          <span className="label-tag text-muted tracking-widest block">// Nos solutions</span>
          <h2 className="text-4xl md:text-5xl font-bold tracking-tight leading-none text-foreground">
            7 produits,
            <br />
            <span className="italic font-light">un seul studio.</span>
          </h2>
        </div>
        <p className="text-muted text-sm max-w-xs leading-relaxed md:text-right">
          WFTECH conçoit et développe des solutions numériques propriétaires couvrant la mobilité, l&apos;agriculture, la santé, les données et l&apos;IA.
        </p>
      </div>
